...
<xsl:key name="glossario" match="tei:label//tei:term[@xml:lang='it']" use="@ref" />
    ...
    <xsl:template match="/"> <!-- Template rules -->
        <html>
            <head>
                ...
                <!-- <script src="map.js"></script> Qui mettermo i file JS-->
                <!-- <link href="stile.css" rel="stylesheet" type="text/css"/> Qui metteremo il file CSS -->
            </head>
            <body>
                <header>
                    <nav class="navMenu">
                ...
                <div id="legenda">
                    ...
                    <ul>
                        ...
                        <li style="background-color:#1a3300">Glottonimi</li>
                        <li style="background-color:#00ffff">Esempi linguistici</li>
                ...
                <div id="p17">
                    <h2>Pagina 17</h2>
                    <button type="button" id="retropag17"> Mostra retro </button>
                        <div>
                            <div class="img">
    ...
    <xsl:template match="//tei:div[@type='pagina']//tei:term[@type='glottonimo']" priority="5"> <!-- il priority è qui necessario per evitare il match ambiguo-->
        <xsl:element name="span">
            <xsl:attribute name="style">background-color:  	 #1a3300</xsl:attribute>
